...
export type WenNewStandard = {
    ...
    instructions: [
        ...
        },
        {
            ...
            docs: ["burn mint"];
            discriminator: [60, 58, 247, 183, 185, 54, 114, 131];
            accounts: [
                {
                    name: "payer";
                    writable: true;
        ...
        },
        {
            ...
            discriminator: [63, 114, 69, 118, 3, 198, 215, 72];
            accounts: [
                {
                    name: "payer";
                    writable: true;
    ...
    accounts: [
        {
            name: "approveAccount";
            discriminator: [218, 253, 170, 2, 4, 47, 25, 99];
        },
        {
            name: "manager";
        ...
        {
            name: "tokenGroup";
            discriminator: [184, 107, 4, 187, 196, 55, 142, 134];
        },
        {
            name: "tokenGroupMember";
            discriminator: [17, 208, 50, 173, 30, 127, 245, 94];
        },
    ];
    errors: [
        {
